<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="年限" prop="nianxian">
          <el-input v-model="ruleForm.nianxian" 
              placeholder="年限" clearable  :readonly="ro.nianxian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="年限" prop="nianxian">
              <el-input v-model="ruleForm.nianxian" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="上课时间" prop="shangkeshijian">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shangkeshijian" label="上课时间" prop="shangkeshijian">
                    <span>{{ruleForm.shangkeshijian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.kechengxiangqing = this.ruleForm.kechengxiangqing.replace(reg,'../../../springbooto8mkp/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
